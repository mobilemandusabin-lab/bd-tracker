              ...
              <div key={item._id} className="p-4 active:bg-amber-50/50 transition-colors border-l-4 border-amber-500">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button onClick={() => { setSelectedLead({ _id: item._id, ...item }); setIsDetailModalOpen(true); }} className="p-2 bg-white border border-amber-200 text-amber-400 hover:text-amber-600 hover:border-amber-300 rounded-lg transition-all">
                      <ExternalLink size={14} />
                    </button>
                  </div>
                </div>
